<nav class="navbar navbar-expand navbar-light tansparent topbar mb-4 static-top shadow">
      ...
      <div class="dropdown-menu dropdown-menu-right p-3 shadow animated--grow-in" aria-labelledby="searchDropdown">
        <form class="form-inline mr-auto w-100 navbar-search">
          <div class="input-group">
            ...
            <div class="input-group-append">
              <button class="btn btn-primary" type="button">
                <i class="fas fa-search fa-sm">hola</i>
              </button>
            </div>
          </div>
        </form>
      ...
      @else
        ...
        <li class="nav-item dropdown no-arrow">
          <a class="nav-link dropdown-toggle mt-4" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <span class="mr-2 d-none d-lg-inline text-gray-600 small"><b class="dark-grey-text">{{ Auth::user()->name }}</b> </span>
