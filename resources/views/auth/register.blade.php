...
<div class="container pb-5 mb-5">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header bg-gradient-dark text-white font-weight-bold"> <i class="fas fa-address-card fa-md" title="Ingrese correo electrónico y contraseña."></i> {{ __('Register') }}</div>
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <div class="col-md-12 text-center">
                                <button type="submit" class="btn btn-dark text-white font-weight-bold">
                                    {{ __('Register') }}
                                </button>
                            </div>
                        </div>
