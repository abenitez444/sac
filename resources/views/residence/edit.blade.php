<div class="modal fade" id="modal-editResidence" tabindex="-1" role="dialog" aria-labelledby="modal-editResidence"
  ...
  <div class="modal-dialog modal-lg" role="residence">
    <div class="modal-content">
      <div class="modal-header info-color-dark"><i class="fas fa-building fa-lg mr-2 mt-1 text-white" title="Seleccione el ente."></i> <h5 class="text-white font-weight-bold"></h5>
