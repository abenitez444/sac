...
<div class="modal fade" id="modal-createResidence" tabindex="-1" role="dialog" aria-labelledby="modal-createResidence"
  ...
  <div class="modal-dialog modal-lg" role="residence">
    <div class="modal-content">
      <div class="modal-header bg-gradient-dark"><i class="fas fa-building fa-lg mr-2 mt-1 text-white" title="Seleccione el ente."></i> <h5 class="text-white font-weight-bold"> Registrar: Conjunto residencial</h5>
      ...
      <div class="modal-body">
        <form id="residence-form" method="POST">
          <input type="hidden" id="id" name="id" value="{{ $residence->first() }}">
          @csrf
          ...
          <div class="row justify-content-center">
            <div class="col-sm-8 col-md-8 col-lg-8">
              ...
              <div class="inputWithIcon">
                ...
                <i class="fas fa-building font-weight-bold" title="Ingrese el nombre del conunto residencial."></i>
      ...
      <div class="modal-footer justify-content-center">
        <button type="button" id="send-residence" class="btn btn-info" ><i class="fas fa-share-square"></i><b> Guardar</b></button>
