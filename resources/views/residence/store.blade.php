  ...
  <div class="modal-dialog modal-lg" role="residence">
    <div class="modal-content">
        ...
        <form id="residence-form" method="POST">
          ...
          <div class="row justify-content-center">
            <div class="col-sm-6 col-md-6 col-lg-6">
              <label for="type_residence" class="dark-grey-text font-weight-bold">Vivienda</label>
              <div class="inputWithIcon">
          ...
          <div class="form-row justify-content-center" id="row-structure">
            <div class="col-md-6 offset-4 mt-1">
              <div class="col-md-4 text-center">
                    <label class="dark-grey-text font-weight-bold">Estructura</label>
                ...
                <div class="col-md-12 m-hidden form-group" id="form-type_center">
                  <div class="form-row">
                      <div class="col-md-6 mt-3">
                          <label for="aliquot_center" class="dark-grey-text font-weight-bold">Alícuota</label>
              ...
              <div class="col-md-12 form-group">
                ...
                <div class="col-md-12 m-hidden form-group" id="form-type_corner">
                  <div class="form-row">
                      <div class="col-md-6 mt-3">
                          <label for="aliquot_corner" class="dark-grey-text font-weight-bold">Alícuota</label>
               ...
               <div class="col-md-12 form-group">
                ...
                <div class="col-md-12 m-hidden form-group" id="form-type_penhouse">
                  <div class="form-row">
                      <div class="col-md-6 mt-3">
                          <label for="aliquot_penhouse" class="dark-grey-text font-weight-bold">Alícuota</label>
              ...
              <div class="col-md-12 form-group">
                ...
                <div class="col-md-12 m-hidden form-group" id="form-type_structure">
                  <div class="form-row">
                      <div class="col-md-6 mt-3">
                          <label for="structure" class="dark-grey-text font-weight-bold">Especifique</label>
                  ...
                  <div class="form-row">
                      <div class="col-md-6 mt-3">
                          <label for="aliquot_structure" class="dark-grey-text font-weight-bold">Alícuota</label>
          ...
          <div class="row justify-content-center mt-3">
            ...
            <div class="col-sm-5 col-md-5 col-lg-5 form-group">
              <label for="number_rif" class="dark-grey-text font-weight-bold">Número (RIF)</label>
              <div class="inputWithIcon">
      ...
      <div class="modal-footer justify-content-center">
        <button type="button" id="send-residence" class="btn deep-orange btn-md"  title="Guardar residencia."><i class="font-weight-bold fas fa-save text-white fa-3x" aria-hidden="true"></i></button>
      </div>
    </div>
  </div>
</div>
